...
def get_args():
    ...
    parser.add("--source_model_dir", type=str, default="models/model_AdvTrain-igamsource-IGAM-tinyimagenet_b16", help="Path to load the source model checkpoints, default=models/model_AdvTrain-igamsource-IGAM-tinyimagenet_b16")
    parser.add("--data_dir", type=str, default="datasets/", help="Path to load datasets from, default=datasets")
    parser.add("--dataset", "-d", type=str, default="cifar10", choices=["cifar10", "cifar100", "tinyimagenet"], help="Path to load dataset, default=cifar100")
    ...
    parser.set_defaults(disc_avg_pool_hw=False)
    ...
    parser.add("--finetuned_source_model_dir", type=str, default="models/adv_trained_finetuned_on_tinyimagenet_upresize", help="Path to save/load the source model checkpoints, default=models/adv_trained_finetuned_on_cifar100")
    ...
    parser.add("--source_task", type=str, default="tinyimagenet", choices=["cifar10", "cifar100", "mnist", "tinyimagenet"], help="Path to load dataset, default=tinyimagenet")
    
    parser.add("--train_size_ratio", type=float, default=1.0, help="Ratio of original training data per class to use, default=1.0")
