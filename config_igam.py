...
def get_args():
    ...
    parser.add("--dataset", "-d", type=str, default="cifar100", choices=["cifar10", "cifar100"], help="Path to load dataset, default=cifar100")
    ...
    parser.add("--finetune_train_steps", type=int, default=4700, help="Maximum number of training steps, default=4700")
    
    parser.add("--finetuned_source_model_dir", type=str, default="models/adv_trained_finetuned_on_cifar100", help="Path to save/load the source model checkpoints, default=models/adv_trained_finetuned_on_cifar100")
    
    parser.add("--train_ig_filename", type=str, default="cifar100_train_ig.npy", help="Filename for train input gradients, default=cifar100_train_ig.npy")
    parser.add("--eval_ig_filename", type=str, default="cifar100_eval_ig.npy", help="Filename for eval input gradients, default=cifar100_eval_ig.npy")
    ...
    parser.add("--only_finetune", dest="only_finetune", action="store_true", help="Only finetune source model to target task without IGAM training default=False")
    parser.set_defaults(only_finetune=False)

    parser.add("--finetune_whole_model", dest="finetune_whole_model", action="store_true", help="Finetune the whole source model to target task default=False")
    parser.set_defaults(finetune_whole_model=False)
