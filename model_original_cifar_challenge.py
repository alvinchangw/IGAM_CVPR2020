...
class Model(object):
  ...
  def __init__(self, mode, dataset='cifar10', train_batch_size=None):
    """ResNet constructor.
...
class ModelExtendedLogits(object):
  """ResNet model."""
  def __init__(self, mode, target_task_class_num=100, train_batch_size=None, input_tensor=None, source_task="cifar10"):
    """ResNet constructor.
